/* @license C3.js v0.6.3 | (c) C3 Team and other contributors | http://c3js.org/ */ ! function (t, e) {
    ...
    function p(t, e) {
        ...
        return (!c || c <= 0) && (c = o.isVertical() ? 95 : o.params.isCategory ? Math.ceil(e(1) - e(0)) - 12 : 110),
            function t(e, i) {
                r = void 0;
    ...
    return (r = S.prototype).init = function () {
        ...
        var n, a, r, s, o, c, d, u = t;
        if (e)
            if (1 === (n = h(e) ? e() : e)) u = [t[0]];
            else if (2 === n) u = [t[0], t[t.length - 1]];
        else if (2 < n) {
            for (s = n - 2, a = t[0], o = ((r = t[t.length - 1]) - a) / (s + 1), u = [a], c = 0; c < s; c++) d = +a + o * (c + 1), u.push(i ? new Date(d) : d);
            u.push(r)
        }
        ...
        var i, n, a, r, s, o, c, d, u, l, h, g, f, p, _, x, y, m, S, w, v, b, A, T, P, C, L, V, G, E, O, I = this,
            R = I.main,
            k = I.d3,
            D = I.config,
        ...
        i.prototype._isCurrentSpace = function () {
            ...
            if (this._skipOptionalSpaces(), this._currentIndex < this._endIndex && "+" == this._string.charAt(this._currentIndex) ? this._currentIndex++ : this._currentIndex < this._endIndex && "-" == this._string.charAt(this._currentIndex) && (this._currentIndex++, a = -1), !(this._currentIndex == this._endIndex || (this._string.charAt(this._currentIndex) < "0" || "9" < this._string.charAt(this._currentIndex)) && "." != this._string.charAt(this._currentIndex))) {
                for (var o = this._currentIndex; this._currentIndex < this._endIndex && "0" <= this._string.charAt(this._currentIndex) && this._string.charAt(this._currentIndex) <= "9";) this._currentIndex++;
                if (this._currentIndex != o)
                    for (var c = this._currentIndex - 1, d = 1; o <= c;) e += d * (this._string.charAt(c--) - "0"), d *= 10;
        ...
        var a, e, i, n, r, s, o, c = this.internal,
            d = [],
            u = c.getMaxDataCount(),
            l = 0,
            h = 0;
        ...
        a = c.convertDataToTargets(e, !0), c.data.targets.forEach(function (t) {
            ...
            for (e = 0; e < a.length; e++)
                if (t.id === a[e].id) {
                    for (n = !0, t.values[t.values.length - 1] && (h = t.values[t.values.length - 1].index + 1), l = a[e].values.length, i = 0; i < l; i++) a[e].values[i].index = h + i, c.isTimeSeries() || (a[e].values[i].x = h + i);
            ...
            for (e = 0; e < d.length; e++)
                if (t.id === d[e])
                    for (h = t.values[t.values.length - 1].index + 1, i = 0; i < l; i++) t.values.push({
                        id: t.id,
                        index: h + i,
        ...
        var O = this,
            ...
            R = O.d3;
        return function () {
            var t, e, i, n, a, r, s, o, c, d, u, l = E.targets,
                h = E.flow,
                g = E.drawBar,
                f = E.drawLine,
                p = E.drawArea,
        ...
        var e, i, n, a, r, s = this,
            ...
            d = "",
            u = s.hasType("gauge");
        if (c && !u) e = this.svgArc.centroid(c), i = isNaN(e[0]) ? 0 : e[0], n = isNaN(e[1]) ? 0 : e[1], a = Math.sqrt(i * i + n * n), d = "translate(" + i * (r = s.hasType("donut") && o.donut_label_ratio ? h(o.donut_label_ratio) ? o.donut_label_ratio(t, s.radius, a) : o.donut_label_ratio : s.hasType("pie") && o.pie_label_ratio ? h(o.pie_label_ratio) ? o.pie_label_ratio(t, s.radius, a) : o.pie_label_ratio : s.radius && a ? (.375 < 36 / s.radius ? 1.175 - 36 / s.radius : .8) * s.radius / a : 0) + "," + n * r + ")";
        else if (c && u && 1 < s.filterTargetsToShow(s.data.targets).length) {
        ...
        if (0 < c.data_groups.length)
            for (s = o.hasNegativeValueInTargets(t), e = 0; e < c.data_groups.length; e++)
                if (0 !== (a = c.data_groups[e].filter(function (t) {
                    ...
                    for (n = a[0], s && u[n] && u[n].forEach(function (t, e) {
                            u[n][e] = t < 0 ? t : 0
        ...
        var n, a, r, s, o, c, d, u, l, h, g = this,
            f = g.config,
        ...
        _.hasArcType() || r.data_selection_enabled && r.data_selection_multiple && (e = _.dragStart[0], i = _.dragStart[1], n = t[0], a = t[1], h = Math.min(e, n), g = Math.max(e, n), f = r.data_selection_grouped ? _.margin.top : Math.min(i, a), p = r.data_selection_grouped ? _.height : Math.max(i, a), s.select("." + Y.dragarea).attr("x", h).attr("y", f).attr("width", g - h).attr("height", p - f), s.selectAll("." + Y.shapes).selectAll("." + Y.shape).filter(function (t) {
            ...
            var i, n, a, r, s, o, c = x.select(this),
                d = c.classed(Y.SELECTED),
                u = c.classed(Y.INCLUDED),
                l = !1;
            if (c.classed(Y.circle)) i = 1 * c.attr("cx"), n = 1 * c.attr("cy"), s = _.togglePoint, l = h < i && i < g && f < n && n < p;
            else {
        ...
        if ("year" === t)
            for (n = (i = this.getXDomain())[0].getFullYear(), a = i[1].getFullYear(), r = n; r <= a; r++) s.push(new Date(r + "-01-01 00:00:00"));
        ...
        var i, n, a, r, s, o, c, d, u, l, h, g, f, _, x, y, m = this,
            S = m.config,
            w = 4,
            v = 10,
            b = 0,
        ...
        }), h = N(t = t || {}, "withTransition", !0), g = N(t, "withTransitionForTransform", !0), m.isLegendInset && (I = S.legend_inset_step ? S.legend_inset_step : p.length, m.updateLegendStep(I)), m.isLegendRight ? (i = function (t) {
            return b * O[t]
        }, r = function (t) {
            return E[O[t]] + L[t]
        ...
        var a, r = this.getScale(t, e, this.isTimeSeries()),
            s = i ? r.domain(i) : r;
        ...
        return function (t, e) {
            var i = h.call(s, t.id)(0),
                ...
                a = c(t),
                r = d(t);
            return s.config.axis_rotated && (0 < t.value && r < i || t.value < 0 && i < r) && (r = i), [
                [a + l, n],
                [a + l, r - (i - n)],
                [a + o - l, r - (i - n)],
                [a + o - l, n]
        ...
        return function (t, e) {
            var i = l.call(s, t.id)(0),
                ...
                a = c(t),
                r = d(t);
            return o.axis_rotated && (0 < t.value && r < i || t.value < 0 && i < r) && (r = i), [
                [a, r - (i - n)],
                [a, r - (i - n)],
                [a, r - (i - n)],
                [a, r - (i - n)]
        ...
        var i, n, a, r, u, s, o, l, h, g, f, p = this,
            _ = p.config,
            x = "M",
        ...
        if (k(e))
            for (i = 0; i < e.length; i++) m[i] = {}, v(e[i].start) ? m[i].start = t[0].x : m[i].start = p.isTimeSeries() ? p.parseDate(e[i].start) : e[i].start, v(e[i].end) ? m[i].end = t[t.length - 1].x : m[i].end = p.isTimeSeries() ? p.parseDate(e[i].end) : e[i].end;
        ...
        for (g = _.axis_rotated ? function (t) {
            ...
            if (v(m) || !S(t[i].x, m)) x += " " + g(t[i]) + " " + f(t[i]);
                ...
                for (r = p.getScale(t[i - 1].x + y, t[i].x + y, p.isTimeSeries()), u = p.getScale(t[i - 1].value, t[i].value), s = c(t[i].x) - c(t[i - 1].x), o = d(t[i].value) - d(t[i - 1].value), h = 2 * (l = 2 / Math.sqrt(Math.pow(s, 2) + Math.pow(o, 2))), n = l; n <= 1; n += h) x += a(t[i - 1], t[i], n, l);
            t[i].x
        }
        return x
        ...
        return o = s.axis_rotated ? o.x0(c).x1(d).y(a) : o.x(a).y0(s.area_above ? 0 : c).y1(d), s.line_connectNull || (o = o.defined(function (t) {
            ...
            function (t) {
                var e, i = s.line_connectNull ? r.filterRemoveNull(t.values) : t.values,
                    n = 0,
                    a = 0;
        ...
        return a.brush = (a.config.axis_rotated ? e.brushY() : e.brushX()).on("brush", function () {
            ...
            return t = a.config.axis_rotated ? [
                [0, e[0]],
                [a.width2, e[1]]
            ] : [
                [e[0], 0],
